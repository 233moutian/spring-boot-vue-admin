...
public class RemitApi {
     ...
     * @throws Exception
     */
     private static PrivateKey readPriKey(String priKey) throws Exception{
         try {
     ...
     * @throws Exception
     */
     private static PublicKey readPubKey(String pubKey) throws Exception{
        try {
     ...
     * @throws Exception
     */
    private static void signWithKey(Map<String,String> params, String keyStr) throws Exception{
...
//        return JSON.parseObject(responseStr, new TypeReference<Map<String, String>>(){});
     ...
     * @return
     */
    public static boolean checkResponse(Map<String, String> params,String pubKey){
        TreeMap<String, String> sortedMap = new TreeMap<String, String>(params);
